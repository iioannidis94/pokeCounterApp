...
Type Effectiveness Chart: Μια μικρή καρτέλα που δείχνει όλο τον πίνακα επιρροών (Type Chart) όταν πατάς πάνω σε έναν τύπο, βοηθώντας τους νέους παίκτες να μάθουν το παιχνίδι.

3. Social & Utility Features
Shareable Team Links: Αντί να στέλνεις ολόκληρο αρχείο .json, θα μπορούσαμε να κωδικοποιήσουμε την ομάδα σε ένα Base64 string (όπως κάνει το Smogon). Έτσι, θα μπορείς να στέλνεις ένα link ([your-site.com/#team=](https://your-site.com/#team=)...) και ο φίλος σου, πατώντας το, να βλέπει αμέσως την ομάδα σου.
